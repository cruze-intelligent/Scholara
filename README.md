...
- [docs/HARDENING_TODO.md](./docs/HARDENING_TODO.md) — scoping/security fixes, CRUD depth,
  user management, notifications, dark theme: the "make it proper" pass in progress
